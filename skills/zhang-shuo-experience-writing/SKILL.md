...
当任务是把《有机化学实验 II》或类似教学、培训、项目运营经历压缩成面向 BRM 的简历段落时，优先读取 [references/approved-teaching-resume-b.md](references/approved-teaching-resume-b.md)，并把 [references/approved-teaching-resume-brm.md](references/approved-teaching-resume-brm.md) 仅作为历史版参考。保留课程系统、复杂运营、知识资产与继任交接三个互补入口；动力学实验必须写出“相邻取样点间隔短于单次操作耗时”造成的节拍约束，以及多人错峰接力如何解决它，不能只罗列人数、样品瓶和流程数量。未核实前，不加入40秒、1分钟、1.5分钟或6人轮换等精确口径。
