# Experience: 北京大学跨学科再训练 / 第二增长曲线探索

> Status: training-environment record, not default resume wording.
> Source: user narrative + private `Zhangsfish/notes` repository structure.
...
The repository currently contains 169 files across 18 directories / topic groups.
...
- 应用微观计量经济学
  ...
  - panel data
  - bunching
  - synthetic control / related methods
  - Stata `.do` files and assignment / TA materials
- 日本经济
- 国发院公开课
...
```text
Attend course / lecture
→ record audio
→ Tencent Hunyuan transcription
→ use transcript + personal notes to maintain attention / capture material
→ discuss confusing or important points with AI after class
→ preserve materials / notes for later reuse
```
