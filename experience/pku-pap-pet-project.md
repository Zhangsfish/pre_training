...
1. **Traditional organic synthesis**
   ...
   - silica-gel / column-chromatography workflows.

2. **Medicinal-chemistry / low-scale purification**
   - compounds below roughly 30 mg scale;
   - HPLC-based purification where ordinary column chromatography was unsuitable.

3. **Radiochemistry / PET**
   - short-lived 68Ga labeling;
   - PET/CT imaging;
...
- conjugation / radiolabeling precursor optimization;
- biochemical PAP inhibition;
- 68Ga radiolabeling and physicochemical testing;
- cell-binding evaluation;
- PET/CT;
- ex vivo biodistribution;
- lead selection.

The public career record should keep this high-level and avoid unpublished molecular details.

## Manuscript-level evidence

The private manuscript documents:
- a focused medicinal-chemistry optimization program;
- PAP-positive / PAP-negative cellular and xenograft models;
- 68Ga radiochemistry;
